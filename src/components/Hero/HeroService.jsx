...
const HeroService = () => {
  ...
  return (
    ...
    >
      <div className="container min-h-[100vh] flex items-center justify-center sm:mt-0 font-space">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center">
          ...
          <div className="space-y-5 order-2 sm:order-1 xl:pr-40 text-black">
            ...
            <h1
              data-aos="fade-up"
              className="text-4xl sm:text-5xl font-semibold font-anton"
            ...
            <p data-aos="fade-up" data-aos-delay="300" className="subheadline">
