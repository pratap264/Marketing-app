      ...
      <div className="container min-h-[100vh] flex items-center justify-center sm:mt-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center">
          ...
          <div className="space-y-5 order-2 sm:order-1 xl:pr-40 text-black">
            ...
            <h1
              data-aos="fade-up"
              className="text-4xl sm:text-5xl font-anton font-semibold"
              style={{ lineHeight: 1.2 }}
            >
              {["Building", "Brands", "in", "the"].map((word, index) => (
                <span
                  key={index}
                  className="inline-block opacity-0 animate-reveal font-anton"
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="300"
              className="subheadline font-space"
            >
            ...
            <button
              ...
              data-aos-delay="500"
              data-aos-offset="0"
              className="primary-btn font-space"
