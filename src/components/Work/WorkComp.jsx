...
const WorkData4 = [
  {
    ...
    description:
      "Designs focused on sustainability, combining eco-friendly materials and innovative concepts to promote green living.",
  },
  {
    id: 11,
    image: Img11,
    title: "Cutting-Edge Tech Showcases",
    description:
      "Highlighting advancements in technology, this design blends futuristic elements with modern aesthetics, showcasing innovation and cutting-edge style.",
  },
  {
    id: 12,
    image: Img12,
    ...
    description:
      "Sophisticated branding solutions tailored for corporations, emphasizing professionalism and brand identity.",
  },
];
...
const WorkComp = () => {
  ...
  return (
    <div className="bg-gray-100 py-10 pb-14 font-space">
